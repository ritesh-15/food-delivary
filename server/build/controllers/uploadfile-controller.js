...
var UploadFileController = /** @class */ (function () {
    ...
    UploadFileController.uploadSingleFile = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                fileInfo = {
                    ...
                    url: "".concat(secrets_1.APP_BASE_URL, "/uploads/").concat(req.file.filename),
                };
                return [2 /*return*/, res.json({ ok: true, fileInfo: fileInfo })];
            });
        });
    };
    UploadFileController.uploadMultipleFiles = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!req.files)
                    return [2 /*return*/, next(Error_Handler_1.default.badRequest())];
                return [2 /*return*/, res.json({ ok: true, files: req.files })];
            });
        });
    };
